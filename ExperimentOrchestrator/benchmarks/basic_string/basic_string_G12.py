...
Author: D4rkia
G12 Optimization: Enable work-stealing dynamic scheduling to utilize idle processor queues
"""
...
def basic(target: str, genes: list[str], debug: bool = True) -> tuple[int, int, str]:
    ...
    while True:
        ...
        # G12: Use ThreadPoolExecutor for I/O-bound selection tasks with work-stealing
        with concurrent.futures.ThreadPoolExecutor(max_workers=None) as executor:
            # G12: Submit all selection tasks for dynamic work distribution
            selection_futures = [
                executor.submit(select, population_score[i], population_score, genes)
