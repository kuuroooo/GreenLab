...
# G7: bulk operations with vectorized centroid computation
def revise_centroids(data, k, cluster_assignment):
    # [G7 applied here: vectorized computation instead of loop]
    return np.array([data[cluster_assignment == i].mean(axis=0) for i in range(k)])
