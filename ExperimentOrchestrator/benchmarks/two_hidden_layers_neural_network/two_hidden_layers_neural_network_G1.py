...
# G1 applied: Replace multiple occurrences of the same expression with a variable.
# Why: Avoid recalculating identical expressions in backprop to reduce redundant work.
