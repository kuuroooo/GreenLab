# === Applied G6: Avoid unnecessary deep copies and duplicate indexing
# Comments mark every change related to G6.
"""
...
def main(
    ...
    for _ in range(iterations_num):
        ...
        for _ in range(ants_num):
            unvisited_cities = dict(cities)  # APPLIED G6: avoid expensive deepcopy; shallow copy is sufficient since values aren't mutated
...
def pheromone_update(
    ...
    for ant_route in ants_route:
        ...
        for i in range(len(ant_route) - 1):  # Update pheromones
            ...
            val = pheromone[ant_route[i]][ant_route[i + 1]]  # APPLIED G6: avoid recomputing same index twice
            pheromone[ant_route[i + 1]][ant_route[i]] = val  # APPLIED G6
