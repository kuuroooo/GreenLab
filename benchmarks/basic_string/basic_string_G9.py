...
Author: D4rkia
G9 Optimization: Reduce data dependencies between iterations to make the code parallelizable
"""
...
def basic(target: str, genes: list[str], debug: bool = True) -> tuple[int, int, str]:
    ...
    while True:
        ...
        with concurrent.futures.ThreadPoolExecutor(max_workers=4) as executor:
            ...
            future_tasks = [executor.submit(create_selection_task, i) for i in range(N_SELECTED)]
