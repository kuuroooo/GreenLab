...
G1 OPTIMIZATION: When there are multiple occurrences of the same expression, 
assign it to a variable and use the variable.
"""
...
class BodySystem:
    ...
    def update_system(self, delta_time: float) -> None:
        ...
        G1 OPTIMIZATION: Extract repeated expressions into variables to avoid
        repeated attribute lookups and calculations.
        ...
        for body1 in bodies:
            force_x = 0.0
            force_y = 0.0
            # G1: Cache body1 attributes to avoid repeated lookups
            ...
            for body2 in bodies:
                if body1 != body2:
                    # G1: Cache body2 attributes to avoid repeated lookups
...
def example_3() -> BodySystem:
    ...
    bodies = []
    # G1: Extract repeated function call into variable
    rand = random.uniform
    for _ in range(10):
