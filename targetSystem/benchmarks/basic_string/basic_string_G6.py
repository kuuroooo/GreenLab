...
Author: D4rkia
G6 Optimization: Avoid storing or saving data that has already been computed, saved, or is unnecessary
"""
...
def select(
    ...
    population_score_len = len(population_score)
    max_index = min(N_SELECTED, population_score_len - 1)
    ...
    for _ in range(child_n):
        ...
        # G6: Avoid redundant computations - use precomputed bounds
        parent_2 = population_score[random.randint(0, max_index)][0]
        child_1, child_2 = crossover(parent_1_str, parent_2)
        
        # G7: Bulk append operations - avoid two separate append calls
...
def basic(target: str, genes: list[str], debug: bool = True) -> tuple[int, int, str]:
    ...
    while True:
        ...
        # G6: Avoid redundant division - compute inverse once and reuse
