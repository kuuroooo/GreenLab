...
class CNN:
        ...
        while rp < n_repeat and mse >= error_accuracy:
            ...
            for p in range(len(datas_train)):
               ...
               """
                ...
                bp_net_j = np.dot(bp_out1, vji_T) - thre_bp2  # G1
                bp_out2 = self.sig(bp_net_j)
                bp_net_k = np.dot(bp_out2, wkj_T) - thre_bp3  # G1
                ...
                pd_conv1_pooled = pd_i_all / size_pooling_sq  # G1
    ...
    def predict(self, datas_test):
        ...
        for p in range(len(datas_test)):
            ...
            bp_out1 = data_bp_input
            bp_net_j = bp_out1 * vji_T - thre_bp2  # G1
            bp_out2 = self.sig(bp_net_j)
            bp_net_k = bp_out2 * wkj_T - thre_bp3  # G1
            bp_out3 = self.sig(bp_net_k)
