# === Applied G4: Short-circuit logical operators to skip unnecessary work
# Comments mark every change related to G4.
"""
    ...
    for _ in range(iterations_num):
        ...
        for _ in range(ants_num):
            ...
            while unvisited_cities:
                # APPLIED G4: use short-circuit 'and' to avoid calling city_select when preconditions fail
                if unvisited_cities and (alpha > 0 and beta > 0):  # APPLIED G4
...
def pheromone_update(
    ...
    for ant_route in ants_route:
        ...
        if ant_route and (total_distance < best_distance):  # APPLIED G4: short-circuit ensures ant_route is non-empty before comparison
            best_path = ant_route
